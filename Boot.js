var BasicGame = {
    ...
    playerInfo: { playerX: 10, playerY: 324},
    gameInfo: { levelList: ['level1', 'level2'], levelPhrase: ['Find 50 grape bunches!.', 'Find 10 grape bunches!'], grapeCount: [50, 10], currentLevel: 0, lastLevel: 1 }
